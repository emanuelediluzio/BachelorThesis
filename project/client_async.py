...
def setup_async_client(description=None, cmdline=None):
    ...
    _logger.info("### Connecting to host: " + args.host)
    _logger.info("### Connecting to port: " + str(args.port))
    _logger.info("### Connecting protocol: " + args.comm)
...
if __name__ == "__main__":
    ...
    asyncio.run(run_async_client(testclient, modbus_calls=None), debug=True)
